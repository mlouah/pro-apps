      ...
      <table class="table table-striped" aria-describedby="taskStatuses">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('proAppsApp.taskStatus.statusPicto')">Status Picto</span></th>
        ...
        <tbody>
          <tr v-for="taskStatus in taskStatuses" :key="taskStatus.id" data-cy="entityTable">
            ...
            <td>
              <a v-if="taskStatus.statusPicto" v-on:click="openFile(taskStatus.statusPictoContentType, taskStatus.statusPicto)">
                <img
              ...
              <span v-if="taskStatus.statusPicto">{{ taskStatus.statusPictoContentType }}, {{ byteSize(taskStatus.statusPicto) }}</span>
            </td>
