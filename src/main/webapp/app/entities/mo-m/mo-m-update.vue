    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('proAppsApp.moM.docWritingDate')" for="mo-m-docWritingDate"
              >Doc Writing Date</label
            >
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="mo-m-docWritingDate"
                  v-model="$v.moM.docWritingDate.$model"
                  name="docWritingDate"
                  class="form-control"
                  :locale="currentLanguage"
                  button-only
              ...
              <b-form-input
                id="mo-m-docWritingDate"
                data-cy="docWritingDate"
                type="text"
                class="form-control"
                name="docWritingDate"
                :class="{ valid: !$v.moM.docWritingDate.$invalid, invalid: $v.moM.docWritingDate.$invalid }"
                v-model="$v.moM.docWritingDate.$model"
              />
            </b-input-group>
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('proAppsApp.moM.deadLine')" for="mo-m-deadLine">Dead Line</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="mo-m-deadLine"
                  v-model="$v.moM.deadLine.$model"
                  name="deadLine"
                  class="form-control"
                  :locale="currentLanguage"
                  button-only
              ...
              <b-form-input
                ...
                class="form-control"
                name="deadLine"
                :class="{ valid: !$v.moM.deadLine.$invalid, invalid: $v.moM.deadLine.$invalid }"
                v-model="$v.moM.deadLine.$model"
              />
            </b-input-group>
          </div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('proAppsApp.moM.decisions')" for="mo-m-decisions">Decisions</label>
            <textarea
              class="form-control"
              name="decisions"
              id="mo-m-decisions"
              data-cy="decisions"
              :class="{ valid: !$v.moM.decisions.$invalid, invalid: $v.moM.decisions.$invalid }"
              v-model="$v.moM.decisions.$model"
            ></textarea>
          </div>
          <div class="form-group">
