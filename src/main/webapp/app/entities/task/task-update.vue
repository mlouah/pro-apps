    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('proAppsApp.task.title')" for="task-title">Title</label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('proAppsApp.task.taskPriority')" for="task-taskPriority">Task Priority</label>
            <select class="form-control" id="task-taskPriority" data-cy="taskPriority" name="taskPriority" v-model="task.taskPriority">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="task.taskPriority && taskPriorityOption.id === task.taskPriority.id ? task.taskPriority : taskPriorityOption"
                v-for="taskPriorityOption in taskPriorities"
                :key="taskPriorityOption.id"
              >
