...
public class MoM implements Serializable {
    ...
    @Column(name = "doc_writing_date")
    private LocalDate docWritingDate;
    ...
    public LocalDate getDocWritingDate() {
        return this.docWritingDate;
    }

    public MoM docWritingDate(LocalDate docWritingDate) {
        this.setDocWritingDate(docWritingDate);
        return this;
    }

    public void setDocWritingDate(LocalDate docWritingDate) {
        this.docWritingDate = docWritingDate;
    }
    ...
    public MoM deadLine(LocalDate deadLine) {
    ...
    public MoM decisions(String decisions) {
    ...
    public String toString() {
        return "MoM{" +
            ...
            ", docWritingDate='" + getDocWritingDate() + "'" +
