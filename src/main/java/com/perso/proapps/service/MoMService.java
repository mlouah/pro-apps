    ...
    public Optional<MoM> partialUpdate(MoM moM) {
        ...
        return moMRepository
            ...
            .map(existingMoM -> {
                ...
                if (moM.getDocWritingDate() != null) {
                    existingMoM.setDocWritingDate(moM.getDocWritingDate());
                }
                if (moM.getDeadLine() != null) {
                    existingMoM.setDeadLine(moM.getDeadLine());
                }
                ...
                if (moM.getDecisions() != null) {
                    existingMoM.setDecisions(moM.getDecisions());
                }
