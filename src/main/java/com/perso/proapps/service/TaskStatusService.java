    ...
    public Optional<TaskStatus> partialUpdate(TaskStatus taskStatus) {
        ...
        return taskStatusRepository
            ...
            .map(existingTaskStatus -> {
                ...
                if (taskStatus.getStatusPicto() != null) {
                    existingTaskStatus.setStatusPicto(taskStatus.getStatusPicto());
                }
                if (taskStatus.getStatusPictoContentType() != null) {
                    existingTaskStatus.setStatusPictoContentType(taskStatus.getStatusPictoContentType());
                }
