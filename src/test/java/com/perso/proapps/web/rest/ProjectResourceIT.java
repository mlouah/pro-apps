...
class ProjectResourceIT {
    ...
    void createProject() throws Exception {
        ...
        assertThat(testProject.getIsInternal()).isEqualTo(DEFAULT_IS_INTERNAL);
        assertThat(testProject.getDateCreation()).isEqualTo(DEFAULT_DATE_CREATION);
        assertThat(testProject.getDateModify()).isEqualTo(DEFAULT_DATE_MODIFY);
        assertThat(testProject.getLastModifyBy()).isEqualTo(DEFAULT_LAST_MODIFY_BY);
    ...
    void putExistingProject() throws Exception {
        ...
        assertThat(testProject.getIsInternal()).isEqualTo(UPDATED_IS_INTERNAL);
        assertThat(testProject.getDateCreation()).isEqualTo(UPDATED_DATE_CREATION);
        assertThat(testProject.getDateModify()).isEqualTo(UPDATED_DATE_MODIFY);
        assertThat(testProject.getLastModifyBy()).isEqualTo(UPDATED_LAST_MODIFY_BY);
