...
class PersonResourceIT {
    ...
    private static final Boolean UPDATED_IS_EXTERNAL = true;
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().name(DEFAULT_NAME).code(DEFAULT_CODE).isExternal(DEFAULT_IS_EXTERNAL).notes(DEFAULT_NOTES);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().name(UPDATED_NAME).code(UPDATED_CODE).isExternal(UPDATED_IS_EXTERNAL).notes(UPDATED_NOTES);
        return person;
    }
    ...
    void createPerson() throws Exception {
        ...
        assertThat(testPerson.getIsExternal()).isEqualTo(DEFAULT_IS_EXTERNAL);
    ...
    void getAllPeople() throws Exception {
        ...
        restPersonMockMvc
            ...
            .andExpect(jsonPath("$.[*].isExternal").value(hasItem(DEFAULT_IS_EXTERNAL.booleanValue())))
    ...
    void getPerson() throws Exception {
        ...
        restPersonMockMvc
            ...
            .andExpect(jsonPath("$.isExternal").value(DEFAULT_IS_EXTERNAL.booleanValue()))
    ...
    void putExistingPerson() throws Exception {
        ...
        updatedPerson.name(UPDATED_NAME).code(UPDATED_CODE).isExternal(UPDATED_IS_EXTERNAL).notes(UPDATED_NOTES);
        ...
        assertThat(testPerson.getIsExternal()).isEqualTo(UPDATED_IS_EXTERNAL);
    ...
    void partialUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.isExternal(UPDATED_IS_EXTERNAL);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.name(UPDATED_NAME).code(UPDATED_CODE).isExternal(UPDATED_IS_EXTERNAL).notes(UPDATED_NOTES);
