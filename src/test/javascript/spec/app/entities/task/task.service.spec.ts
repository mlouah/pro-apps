...
describe('Service Tests', () => {
  describe('Task Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Task(123, 'AAAAAAA', 'AAAAAAA', currentDate, currentDate, currentDate, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            dealLine: dayjs(currentDate).format(DATE_FORMAT),
